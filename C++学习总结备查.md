...
- [shared_ptr](https://zh.cppreference.com/w/cpp/memory/shared_ptr)，拥有共享对象所有权的智能指针。
  ...
  - 类 继承 [enable_shared_from_this](https://zh.cppreference.com/w/cpp/memory/enable_shared_from_this)，则允许 类 创建 并 通过 [shared_from_this()](https://zh.cppreference.com/w/cpp/memory/enable_shared_from_this/shared_from_this) 来获得 指向 this 的 `shared_ptr`。
  - 对于这两点，unique_ptr 和 weak_ptr两个同理。
...
- [C++ 属性： likely, unlikely (C++20 起) - cppreference.com](https://zh.cppreference.com/w/cpp/language/attributes/likely)。
- 
...
- std::function
  ...
  可参考 [c++11新特性之std::function和lambda表达式 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/137884434)。

- std::bind

  可参考 [【C++】C++11的std::function和std::bind用法详解_c++11 新增了 std::function、std::bind-CSDN博客](https://blog.csdn.net/qq_38410730/article/details/103637778)。
